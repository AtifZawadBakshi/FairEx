                ...
                <div className="col-12">
                    <div className="card">
                        <div className="card-header">
                             <div className="row">
                                 <div className="col-7">
                                    <h5 className="card-title">Permissions  
                                        <button type="button" 
                        ...
                        <Pagination links={permission.links} onChangePaginate={paginateData} />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id="staticBackdropLabel"> {itemEdit? "Edit Permission" :"Add Permission" } </h5>
